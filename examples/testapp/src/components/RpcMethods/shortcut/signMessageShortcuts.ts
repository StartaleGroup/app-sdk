...
const walletDeterministicSignShortcuts: ShortcutType[] = [
	{
		key: EXAMPLE_MESSAGE,
		data: {
			message: EXAMPLE_MESSAGE,
...
const ethSignTypedDataV3Shortcuts: (chainId) => ShortcutType[] = (
	chainId: number,
) => [
	{
		key: EXAMPLE_MESSAGE,
...
export const signMessageShortcutsMap = (chainId: number) => ({
	...
	wallet_deterministicSign: walletDeterministicSignShortcuts,
})
