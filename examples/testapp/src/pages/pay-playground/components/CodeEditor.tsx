		...
		<div className={styles.editorPanel}>
			...
			<div className={styles.securityDisclaimer}>
				...
				<div className={styles.disclaimerText}>
					Intended for testing purposes only. Never paste code from
					untrusted sources. Coinbase is not responsible for any loss of
					funds that you incur. Testnet funds hold no real value.
				</div>
			</div>
