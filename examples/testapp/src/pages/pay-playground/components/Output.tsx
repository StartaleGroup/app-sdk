								...
								<div className={styles.userDataBody}>
									{result.payerInfoResponses.name && (
										<div className={styles.userDataRow}>
											<span className={styles.userDataLabel}>
												Name
											</span>
											<span className={styles.userDataValue}>
												{(() => {
													const name = result.payerInfoResponses
														.name as unknown as {
														firstName: string
														familyName: string
													}
									...
									{result.payerInfoResponses.physicalAddress && (
										<div className={styles.userDataRow}>
											...
											<span className={styles.userDataValue}>
												{(() => {
													const addr = result.payerInfoResponses
														.physicalAddress as unknown as {
														address1: string
														address2?: string
														city: string
														state: string
													...
													const parts = [
														addr.name
															? `${addr.name.firstName} ${addr.name.familyName}`
															: null,
														addr.address1,
														addr.address2,
