...
describe('validateStringAmount', () => {
	...
	it('should reject invalid amounts', () => {
		expect(() => validateStringAmount('0', 6)).toThrow(
			'Invalid amount: must be greater than 0',
		)
		expect(() => validateStringAmount('-10', 6)).toThrow(
			'Invalid amount: must be greater than 0',
		)
		expect(() => validateStringAmount('abc', 6)).toThrow(
	...
	it('should reject non-string amounts', () => {
		expect(() => validateStringAmount(10 as any, 6)).toThrow(
			'Invalid amount: must be a string',
		)
	})
