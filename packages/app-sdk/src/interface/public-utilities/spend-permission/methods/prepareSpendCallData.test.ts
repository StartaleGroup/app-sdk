...
import {
	PrepareSpendCallDataResponseType,
	prepareSpendCallData,
} from './prepareSpendCallData.js'
...
describe('prepareSpendCallData', () => {
	...
	it('should call toSpendPermissionArgs with the correct permission', async () => {
		...
		expect(mockToSpendPermissionArgs).toHaveBeenCalledWith(
			mockSpendPermission,
		)
	})
	...
	it('should handle zero amount', async () => {
		...
		await expect(
			prepareSpendCallData(mockSpendPermission, zeroAmount),
	...
	it('should throw error when amount exceeds remaining spend', async () => {
		...
		await expect(
			prepareSpendCallData(mockSpendPermission, excessiveAmount),
		).rejects.toThrow('Remaining spend amount is insufficient')
	})
