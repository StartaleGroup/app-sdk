...
describe('requestSpendPermission', () => {
	...
	let mockRequestData: RequestSpendPermissionType & {
		provider: ProviderInterface
	}

	const mockSignature =
		'0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef12'
	const mockPermissionHash =
	...
	describe('successful requests', () => {
		it('should create spend permission successfully', async () => {
			...
			expect(createSpendPermissionTypedData).toHaveBeenCalledWith(
				mockRequestData,
			)
	...
	describe('error handling', () => {
		it('should propagate provider signature errors', async () => {
			...
			;(mockProviderRequest as Mock).mockRejectedValue(
		...
		it('should handle RPC errors from provider', async () => {
			...
			await expect(requestSpendPermission(mockRequestData)).rejects.toEqual(
				rpcError,
			)
		})
