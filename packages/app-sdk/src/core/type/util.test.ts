...
describe('util', () => {
	...
	test('endcodeToHexString', () => {
		...
		expect(
			encodeToHexString(
				'My name is Giovanni Giorgio, but everybody calls me... Jungho',
			),
	...
	test('ensureBuffer', () => {
		...
		expect(ensureBuffer(hexString).buffer).toEqual(
			Uint8Array.from([
				140, 22, 81, 137, 137, 56, 98, 28, 52, 215, 100, 110, 146, 161, 33,
				228, 175, 127, 154, 17, 189, 218, 72, 67, 182, 57, 17, 81, 245, 199,
				172, 231,
			]).buffer,
		)
