...
import { createStartaleAccountSDK } from './interface/builder/core/createStartaleAccountSDK.js'
...
if (typeof window !== 'undefined') {
	...
	;(window as any).createStartaleAccountSDK = createStartaleAccountSDK
}
